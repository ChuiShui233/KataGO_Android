...
// Forward declaration for autotuning recovery (full definition in opencltuning_recovery.h)
namespace OpenCLTuningRecovery { class State; }
...
struct OpenCLTuneParams {
  ...
  static std::string saveToString(const OpenCLTuneParams& config);
...
namespace OpenCLTuner {
  ...
  void tune(
    ...
    OpenCLTuningRecovery::State* recoveryState = nullptr
  );
